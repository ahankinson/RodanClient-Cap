...
app (projectName, function(task)
{
    ...
    task.setBuildIntermediatesPath(FILE.join("Build", "RodanNext.build", configuration));
    task.setBuildPath(FILE.join("Build", configuration));

    task.setProductName("RodanNext");
    task.setIdentifier("com.yourcompany.RodanNext");
    task.setVersion("1.0");
